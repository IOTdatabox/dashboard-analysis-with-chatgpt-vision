...
const UploadPage = () => {
  ...
  const addUserData = async (userName: any, userEmail: any, companySize: any) => {
  ...
  return (
    <>
      <section className="container max-w-[90rem] mx-auto text-gray-600 body-font bg-gray-950">
        ...
        {/* supporters */}
        <div className="w-[70rem] xl:w-[90rem] xl:h-[50px] justify-start items-center gap-[70px] mt-16 mb-20 inline-flex">
